...
/*
Output - Should also show transcations
...
int main()
{
	...
	//Iterate over the persons, add these person in the multiset who have non zero net
	...
	while(!m.empty())
	{
		...
		//Print the Transcation between people
